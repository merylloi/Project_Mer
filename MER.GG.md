...
-- WINDOW
local Window = OrionLib:MakeWindow({Name = "MER.GG HUB", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
Tab:AddButton({
	...
	Callback = function()
      	if player.Character and player.Character:FindFirstChild("Humanoid") then
            ...
            player.Character.Humanoid.WalkSpeed = walkSpeedEnabled and 64 or 16 -- Default walkspeed is 16
            OrionLib:MakeNotification({
                Name = "Walk Speed",
...
Tab:AddButton({
    Name = "Toggle High Jump Power",
    Callback = function()
        if player.Character and player.Character:FindFirstChild("Humanoid") then
            jumpPowerEnabled = not jumpPowerEnabled
            player.Character.Humanoid.JumpPower = jumpPowerEnabled and 500 or 50 -- Default jump power is 50
            OrionLib:MakeNotification({
                Name = "Jump Power",
